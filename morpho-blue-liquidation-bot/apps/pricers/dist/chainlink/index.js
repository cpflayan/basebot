import { DENOMINATIONS, FEED_REGISTRY_ADDRESS, MAPPINGS, } from "@morpho-blue-liquidation-bot/config";
import { formatUnits, } from "viem";
import { readContract } from "viem/actions";
import { mainnet } from "viem/chains";
import { feedRegistryAbi } from "../abis/feedRegistry";
export class ChainlinkPricer {
    CACHE_TIMEOUT_MS = 30_000; // 30 seconds
    priceCache = new Map();
    async price(client, asset) {
        ...
        const coinKey = `${client.chain.name}:${asset}`;
