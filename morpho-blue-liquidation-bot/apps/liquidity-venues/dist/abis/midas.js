export const redemptionVaultAbi = [
    ...
    },
    {
        ...
        outputs: [{ internalType: "contract IRedemption", name: "", type: "address" }],
        stateMutability: "view",
        type: "function",
    },
    {
    ...
    },
    {
        inputs: [],
        name: "mTokenDataFeed",
        outputs: [{ internalType: "contract IDataFeed", name: "", type: "address" }],
        stateMutability: "view",
        type: "function",
    },
    {
    ...
    {
        inputs: [{ internalType: "uint256", name: "amountMTokenIn", type: "uint256" }],
    ...
    {
        inputs: [{ internalType: "uint256", name: "newInstantFee", type: "uint256" }],
        name: "setInstantFee",
        outputs: [],
        stateMutability: "nonpayable",
        type: "function",
    ...
    {
        inputs: [{ internalType: "uint256", name: "_minBuidlBalance", type: "uint256" }],
        name: "setMinBuidlBalance",
        outputs: [],
        stateMutability: "nonpayable",
        type: "function",
    ...
    {
        inputs: [{ internalType: "uint256", name: "_minBuidlToRedeem", type: "uint256" }],
        name: "setMinBuidlToRedeem",
        outputs: [],
        stateMutability: "nonpayable",
        type: "function",
    ...
    {
        inputs: [{ internalType: "address", name: "newSanctionsList", type: "address" }],
        name: "setSanctionsList",
        outputs: [],
        stateMutability: "nonpayable",
        type: "function",
