...
export type LiquidityVenueName = "1inch" | "aerodrome" | "erc20Wrapper" | "erc4626" | "lifi" | "liquidSwap" | "midas" | "pendlePT" | "uniswapV3" | "uniswapV4" | "zeroEx";
...
export type ChainConfig = Omit<Config, "options"> & Options & {
    chainId: number;
    rpcUrl: string;
