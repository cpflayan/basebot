...
var counter$3 = makeOrThrow("envio_source_request_count", "The number of requests made to data sources.", sourceRequestLabelsSchema);

function increment$2(sourceName, chainId, method) {
  increment(counter$3, {
        source: sourceName,
        chainId: chainId,
        method: method
