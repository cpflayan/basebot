import { type Abi, type AbiStateMutability, type Address, type Client, type ContractFunctionArgs, type ContractFunctionName, type Hash } from "viem";
 ...
 * ```
 */
export declare function getFunctionCalls<TAbi extends Abi, TName extends ContractFunctionName<TAbi>>(client: Client, { txHash, abi, contract, functionName }: GetFunctionCallsArgs<TAbi, TName>): Promise<FunctionCall<TAbi, TName>[]>;
