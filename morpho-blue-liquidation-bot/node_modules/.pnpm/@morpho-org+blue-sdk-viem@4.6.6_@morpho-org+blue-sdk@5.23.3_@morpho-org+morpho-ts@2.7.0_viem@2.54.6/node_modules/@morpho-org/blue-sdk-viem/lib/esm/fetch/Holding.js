import { ChainUtils, ERC20_ALLOWANCE_RECIPIENTS, getChainAddresses, Holding, NATIVE_ADDRESS, permissionedBackedTokens, permissionedWrapperTokens, } from "@morpho-org/blue-sdk";
...
import { erc2612Abi, permissionedErc20WrapperAbi, permit2Abi, whitelistControllerAggregatorV2Abi, wrappedBackedTokenAbi, } from "../abis.js";
import { abi, code } from "../queries/GetHolding.js";
export const optionalBoolean = [undefined, false, true];
// biome-ignore lint/complexity/useMaxParams: TODO refactor to ≤2 params
export async function fetchHolding(user, token, client, { deployless = true, ...parameters } = {}) {
    ...
    if (deployless) {
        const { morpho, permit2 = zeroAddress, bundler3: { generalAdapter1 }, } = getChainAddresses(parameters.chainId);
        try {
            const { balance, erc20Allowances: { generalAdapter1: generalAdapter1Erc20Allowance, ...erc20Allowances }, permit2BundlerAllowance, isErc2612, erc2612Nonce, canTransfer, } = await readContract(client, {
                ...parameters,
                abi,
                code,
                functionName: "query",
    ...
    const [balance, erc20Allowances, permit2BundlerAllowance, erc2612Nonce, whitelistControllerAggregator, hasErc20WrapperPermission,] = await Promise.all([
        ...
        Promise.all(ERC20_ALLOWANCE_RECIPIENTS.map(async (label) => {
