...
export const safeParseNumber = (value, decimals = 18) => safeParseUnits(toFixed(value, decimals), decimals);
export const safeParseUnits = (strValue, decimals = 18) => {
...
export const safeGetAddress = (address) => getAddress(address.toLowerCase());
 ...
 * ```
 */
export function restructure(outputs, parameters) {
 ...
 */
export async function readContractRestructured(client, parameters) {
