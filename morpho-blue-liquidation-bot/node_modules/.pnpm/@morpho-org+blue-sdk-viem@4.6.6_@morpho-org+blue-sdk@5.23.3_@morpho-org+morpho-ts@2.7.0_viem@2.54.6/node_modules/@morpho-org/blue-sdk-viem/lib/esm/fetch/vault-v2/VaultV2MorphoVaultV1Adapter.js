import { AccrualVaultV2MorphoVaultV1Adapter, getChainAddresses, UnknownFactory, UnknownOfFactory, VaultV2MorphoVaultV1Adapter, } from "@morpho-org/blue-sdk";
import { erc20Abi } from "viem";
import { getChainId, readContract } from "viem/actions";
import { morphoVaultV1AdapterAbi, morphoVaultV1AdapterFactoryAbi, } from "../../abis.js";
import { isUnknownOfFactoryError } from "../../error.js";
import { abi, code, } from "../../queries/vault-v2/GetVaultV2MorphoVaultV1Adapter.js";
import { fetchAccrualVault } from "../Vault.js";
// biome-ignore lint/complexity/useMaxParams: TODO refactor to ≤2 params
export async function fetchVaultV2MorphoVaultV1Adapter(address, client, { deployless = true, ...parameters } = {}) {
...
// biome-ignore lint/complexity/useMaxParams: TODO refactor to ≤2 params
export async function fetchAccrualVaultV2MorphoVaultV1Adapter(address, client, parameters = {}) {
