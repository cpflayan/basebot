...
const VaultMarketPublicAllocatorConfig_js_1 = require("./VaultMarketPublicAllocatorConfig.js");
...
async function fetchVaultMarketConfig(vault, marketId, client, parameters = {}) {
    ...
    const [[cap, enabled, removableAt], pendingCap, publicAllocatorConfig] = await Promise.all([
        ...
        (0, VaultMarketPublicAllocatorConfig_js_1.fetchVaultMarketPublicAllocatorConfig)(vault, marketId, client, parameters),
    ]);
