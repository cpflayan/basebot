...
export class Trade {
                ...
                if (i === route.pools.length - 1) {
                    ...
                    if (isEthWethPool) {
                        if (route.output.isNative && ((_a = route.pools[i - 1]) === null || _a === void 0 ? void 0 : _a.currency0.isNative)) {
                            ...
                            tokenAmount = CurrencyAmount.fromFractionalAmount(pool.currency0, // native currency
                            ...
                            tokenAmount = CurrencyAmount.fromFractionalAmount(pool.currency1, // wrapped currency
                            tokenAmount.numerator, tokenAmount.denominator);
                        }
                    }
                }
    ...
    constructor({ routes, tradeType, }) {
        ...
        invariant(routes.every(({ route }) => inputCurrency.equals(route.input)), 'INPUT_CURRENCY_MATCH');
        invariant(routes.every(({ route }) => outputCurrency.equals(route.output)), 'OUTPUT_CURRENCY_MATCH');
