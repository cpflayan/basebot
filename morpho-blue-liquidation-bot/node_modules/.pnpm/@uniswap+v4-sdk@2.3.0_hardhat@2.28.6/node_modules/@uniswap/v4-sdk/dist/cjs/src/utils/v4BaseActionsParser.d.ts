...
import { Actions, URVersion } from './v4Planner';
export type Param = {
...
export declare abstract class V4BaseActionsParser {
    static parseCalldata(calldata: string, urVersion?: URVersion): V4RouterCall;
