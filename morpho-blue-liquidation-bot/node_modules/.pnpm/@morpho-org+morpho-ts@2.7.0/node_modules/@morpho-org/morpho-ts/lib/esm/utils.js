 ...
 * ```
 */
export const isNotUndefined = (v) => v !== undefined;
/**
 ...
 * ```
 */
export const bigIntComparator = (getter, order = "asc") => (a, b) => {
    const xA = getter(a);
    const xB = getter(b);
    if (xA == null && xB == null)
        return 0;
 ...
 * ```
 */
export const hasValue = (data, path) => isDefined(getValue(data, path));
/**
 ...
 * ```
 */
export const createHasValue = (path) => (data) => hasValue(data, path);
/**
 ...
 * ```
 */
export const getValue = (data, path) => _get(data, path.split("."));
/**
 ...
 * ```
 */
export const transformValue = (value, _transform) => (isDefined(value) ? _transform(value) : value);
/**
 ...
 * ```
 */
export const createGetValue = (path) => (data) => getValue(data, path);
/**
 ...
 * ```
 */
export const fromEntries = (srcEntries) => Object.fromEntries(srcEntries);
/**
 ...
 * ```
 */
export const mergeEntries = (srcEntries, merger) => {
    const obj = {};
 ...
 * ```
 */
export const retryPromiseLinearBackoff = async (func, { timeout = 100, retries = 8, onError, }) => {
    let i = 0;
    do {
        try {
            return await func();
 ...
 * ```
 */
export function getLastDefined(array) {
 ...
 * ```
 */
export function assertNonNegative(field, value) {
    if (value < 0n)
        throw new NegativeValueError(field, value);
}
/**
