...
exports.unwrappedTokensMapping = exports.blueDeployments = exports.blueAddresses = exports.blueAddressRegistry = exports.deployments = exports.addresses = exports.addressesRegistry = exports.convexWrapperTokens = exports.getPermissionedCoinbaseTokens = exports.permissionedCoinbaseTokens = exports.permissionedBackedTokens = exports.permissionedWrapperTokens = exports.erc20WrapperTokens = exports.getChainAddress = exports.getChainAddresses = exports.NATIVE_ADDRESS = void 0;
...
const _addressesRegistry = {
    ...
    [chain_js_1.ChainId.PolygonMainnet]: {
        ...
        morphoMarketV1AdapterV2Factory: "0xc0006f52B38625C283dd2f972dD9B779A5851Dd0",
    ...
    [chain_js_1.ChainId.OptimismMainnet]: {
        ...
        morphoMarketV1AdapterV2Factory: "0x71B299bDb52b6396429cd1E11c418324502CB434",
    ...
    [chain_js_1.ChainId.WorldChainMainnet]: {
        ...
        morphoMarketV1AdapterV2Factory: "0xEd0b06fcdDB6dD0985e2de9D22ad034d313b7dBd",
    ...
    [chain_js_1.ChainId.Unichain]: {
        ...
        morphoMarketV1AdapterV2Factory: "0x9a13bdA35F98811fbAcf097966b2C838f3F9c58C",
    ...
    [chain_js_1.ChainId.PlumeMainnet]: {
        ...
        morphoMarketV1AdapterV2Factory: "0xB7c243AfACb25870775ADFdAe9D0EAc2324dD152",
    ...
    [chain_js_1.ChainId.KatanaMainnet]: {
        ...
        morphoMarketV1AdapterV2Factory: "0x6d6A3ba62836d6B40277767dCAc8fd390d4BcedC",
    ...
    [chain_js_1.ChainId.HyperliquidMainnet]: {
        ...
        morphoMarketV1AdapterV2Factory: "0xaEff6Ef4B7bbfbAadB18b634A8F11392CBeB72Be",
    ...
    [chain_js_1.ChainId.EdenMainnet]: {
    ...
    [chain_js_1.ChainId.PharosMainnet]: {
    ...
    [chain_js_1.ChainId.GensynMainnet]: {
    ...
    [chain_js_1.ChainId.FlareMainnet]: {
    ...
    [chain_js_1.ChainId.RobinhoodMainnet]: {
...
const _deployments = {
    ...
    [chain_js_1.ChainId.RobinhoodMainnet]: {
        ...
        morphoVaultV1AdapterFactory: 58781n,
        registryList: 289n,
...
const getChainAddresses = (chainId) => {
    const chainAddresses = exports.blueAddresses[chainId];
 ...
 * ```
 */
const getChainAddress = (chainId, label) => {
    const chainAddresses = exports.blueAddresses[chainId];
    if (chainAddresses == null)
        throw new errors_js_1.UnsupportedChainIdError(chainId);
    let address = chainAddresses;
    ...
    if (typeof address !== "string")
        throw new errors_js_1.UnknownAddressError({ chainId, label: String(label) });
    return address;
};
...
const _unwrappedTokensMapping = {
    ...
    [chain_js_1.ChainId.EdenMainnet]: {
        [_addressesRegistry[chain_js_1.ChainId.EdenMainnet].wNative]: exports.NATIVE_ADDRESS,
    },
    [chain_js_1.ChainId.PharosMainnet]: {
        [_addressesRegistry[chain_js_1.ChainId.PharosMainnet].wNative]: exports.NATIVE_ADDRESS,
    },
    [chain_js_1.ChainId.GensynMainnet]: {
        [_addressesRegistry[chain_js_1.ChainId.GensynMainnet].wNative]: exports.NATIVE_ADDRESS,
    },
    [chain_js_1.ChainId.FlareMainnet]: {
        [_addressesRegistry[chain_js_1.ChainId.FlareMainnet].wNative]: exports.NATIVE_ADDRESS,
    },
    [chain_js_1.ChainId.XdcMainnet]: {
        [_addressesRegistry[chain_js_1.ChainId.XdcMainnet].wNative]: exports.NATIVE_ADDRESS,
    },
    [chain_js_1.ChainId.KaiaMainnet]: {
    ...
    [chain_js_1.ChainId.RobinhoodMainnet]: {
        [_addressesRegistry[chain_js_1.ChainId.RobinhoodMainnet].wNative]: exports.NATIVE_ADDRESS,
    },
};
/**
...
(0, utils_js_1.entries)(exports.permissionedBackedTokens).forEach(([chainId, tokens]) => {
    tokens.forEach((token) => (exports.erc20WrapperTokens[chainId] ??= new Set()).add(token));
});
(0, utils_js_1.entries)(exports.permissionedCoinbaseTokens).forEach(([chainId, tokens]) => {
    tokens.forEach((token) => (exports.permissionedWrapperTokens[chainId] ??= new Set()).add(token));
});
(0, utils_js_1.entries)(exports.permissionedWrapperTokens).forEach(([chainId, tokens]) => {
    tokens.forEach((token) => (exports.erc20WrapperTokens[chainId] ??= new Set()).add(token));
});
...
exports.addressesRegistry = (0, utils_js_1.deepFreeze)(_addressesRegistry);
...
exports.deployments = (0, utils_js_1.deepFreeze)(_deployments);
/** Alias of `addressesRegistry` kept for Blue package compatibility. */
exports.blueAddressRegistry = exports.addressesRegistry;
/** Alias of `addressesRegistry` matching the previous Blue object-style export. */
exports.blueAddresses = exports.blueAddressRegistry;
/** Alias of `deployments` kept for Blue package compatibility. */
exports.blueDeployments = exports.deployments;
/** Deep-frozen registry of wrapped token to unwrapped token mappings. */
exports.unwrappedTokensMapping = (0, utils_js_1.deepFreeze)(_unwrappedTokensMapping);
const isRecord = (value) => value != null &&
    typeof value === "object" &&
    Object.getPrototypeOf(value) === Object.prototype;
const isRegistryPrimitive = (value) => ["string", "bigint", "number", "boolean"].includes(typeof value);
const cloneRegistryValue = (value) => {
    if (!isRecord(value))
        return value;
    const next = {};
...
const areRegistryValuesEqual = ({ base, patch, type, }) => {
    if (type === "address" &&
        typeof base === "string" &&
        typeof patch === "string")
...
const assertRequiredBlueRegistry = ({ chainId, entry, type, }) => {
    ...
    if (isRecord(entry) &&
        ...
        return;
    throw new errors_js_1.IncompleteChainRegistryError({
        chainId,
        type,
    });
};
const mergeRegistry = ({ base, patch, label, type, }) => {
    if (patch === undefined)
        return base;
    ...
    if (base !== undefined) {
        if (!areRegistryValuesEqual({ base, patch, type })) {
            if (!isRegistryPrimitive(base) || !isRegistryPrimitive(patch)) {
                throw new errors_js_1.RegistryValueAlreadyRegisteredError({
                    label,
    ...
    return cloneRegistryValue(patch);
};
const refreshAddressViews = () => {
    exports.addresses = exports.addressesRegistry;
    exports.blueAddresses = exports.blueAddressRegistry = exports.addressesRegistry;
};
const refreshDeploymentViews = () => {
    exports.blueDeployments = exports.deployments;
};
const withBlueAlias = ({ entry, label, type, }) => {
    if (entry.blue == null && entry.morpho == null)
        return { ...entry };
    if (entry.blue != null &&
        entry.morpho != null &&
...
function registerCustomAddresses({ unwrappedTokens, addresses: customAddresses, deployments: customDeployments, } = {}) {
    if (customAddresses) {
        ...
        for (const [chainIdString, requestedAddresses] of Object.entries(customAddresses)) {
            const chainId = Number(chainIdString);
            const registeredEntry = nextRegistry[chainId];
            const requestedEntry = cloneRegistryValue(withBlueAlias({
        ...
        exports.addressesRegistry = (0, utils_js_1.deepFreeze)(nextRegistry);
        refreshAddressViews();
    }
    if (customDeployments) {
        ...
        for (const [chainIdString, requestedDeployments] of Object.entries(customDeployments)) {
            const chainId = Number(chainIdString);
            const registeredEntry = nextRegistry[chainId];
            const requestedEntry = cloneRegistryValue(withBlueAlias({
        ...
        exports.deployments = (0, utils_js_1.deepFreeze)(nextRegistry);
        refreshDeploymentViews();
    }
    if (unwrappedTokens) {
        exports.unwrappedTokensMapping = (0, utils_js_1.deepFreeze)(mergeRegistry({
            base: exports.unwrappedTokensMapping,
