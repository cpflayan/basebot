 ...
 * ```
 */
export const getLocaleSymbols = (locale) => {
    let formatter;
...
export const convertNumStrToLocal = (numStr, from, to) => {
 ...
 * ```
 */
export const convertNumStrFromEffectiveTo = (numStr, to) => {
 ...
 * ```
 */
export const getEnUSNumberToLocalParts = (numStr, locale) => {
