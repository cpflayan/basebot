...
import { type DealParameters } from "./actions/deal";
...
export declare function dealActions<chain extends Chain | undefined = Chain | undefined, account extends Account | undefined = Account | undefined>(client: TestClient<TestClientMode, Transport, chain, account, false>): DealActions<account>;
