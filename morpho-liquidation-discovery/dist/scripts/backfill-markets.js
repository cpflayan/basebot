...
const MORPHO_BLUE_DEPLOY_BLOCK = 13977148n; // Morpho Blue 在 Base 的實際部署塊（二分法確認）
        ...
        try {
            ...
            for (const log of logs) {
                ...
                try {
                    ...
                    console.error(`  ⚠️  解碼事件失敗 (block ${log.blockNumber}):`, e.message);
                }
            }
        }
        catch (e) {
            console.error(`  ⚠️  查詢區塊 ${fromBlock}-${toBlock} 失敗:`, e.message);
        }
